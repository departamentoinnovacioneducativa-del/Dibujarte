...
const colors = [
  ...
  '#2EC4B6', '#5BC0EB', '#4D96FF', '#4361EE', // Izquierda (10)
  '#9D4EDD', '#C77DFF', '#FF6BCB', '#FF006E', '#8B4513', '#D4A574', 
  '#FFFFFF', '#C0C0C0', '#808080', '#000000' // Derecha (10)
];
...
colors.forEach((color, i) => {
  ...
  pencil.setAttribute('aria-label', 'Color ' + color);
  ...
  if (i < 10) {
    leftPencils.appendChild(pencil);
  } else {
    rightPencils.appendChild(pencil);
  }
});
